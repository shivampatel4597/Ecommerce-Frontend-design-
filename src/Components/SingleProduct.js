...
class SingleProduct extends Component {
    ...
    return (
      ...
      <div className='w-full flex item-center justify-center  bg-gray-100' >
         ...
         <div className='w-[80%] flex item-center justify-center h-[full] bg-white '>
            <div className='w-[35%] '>
              <img src={arr.images ? arr.images[0] : ""} className='w-full mb-7 p-3 text-yellow-400  bg-green-300' />
  ...
  {/* general intro */}
              ...
              <div className='mt-3 text-start w-full '>
                ...
                <span className='text-2xl  font-bold'>Rs {Math.round(arr.price *80)}</span><span className='px-6 text-green-400'>{arr.discountPercentage}% off</span>
              </div>
...
{arr.reviews && arr.reviews.map((item,index)=>{
  return  <div className='mt-2 flex flex-col items-start justify-start '>
